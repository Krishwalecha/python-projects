...
class QuizInterface:
    def __init__(self, quiz_brain: QuizBrain):
        ...
        self.true_button = Button(image=true_img, highlightthickness=0, bd=0, command=self.true_clicked)
        self.true_button.image = true_img
        self.true_button.grid(row=2, column=0, pady=20)

        false_img = PhotoImage(file="./images/false.png")
        self.false_button = Button(image=false_img, highlightthickness=0, bd=0, command=self.false_clicked)
