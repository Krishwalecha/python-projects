data = [
    ...
    {'name': 'Stephen Curry', 'follower_count': 48, 'description': 'Basketball player', 'country': 'United States'},
    {'name': 'Eminem', 'follower_count': 46, 'description': 'Musician', 'country': 'United States'},
    {'name': 'Gal Gadot', 'follower_count': 45, 'description': 'Actress and model', 'country': 'Israel'},
    {'name': 'Bill Gates', 'follower_count': 44, 'description': 'Business magnate', 'country': 'United States'},
    {'name': 'Oprah Winfrey', 'follower_count': 43, 'description': 'Talk show host', 'country': 'United States'},
]
